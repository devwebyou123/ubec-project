...
import '../Responsive/responsive1.dart';
    ...
    return CustomCard(
      ...
      child: Column(
        ...
        children: [
          ...
          AspectRatio(
            aspectRatio: Responsive.isMobile(context) ? 3 / 2 : 3 / 1,
            child: LineChart(
              LineChartData(
                  ...
                  LineChartBarData(
                    ...
                    belowBarData: BarAreaData(
                      gradient: LinearGradient(
                        ...
                        colors: isDarkMode
                            ? [Colors.cyanAccent.withOpacity(0.5), Colors.transparent]
                            : [Colors.blueAccent.withOpacity(0.5), Colors.transparent],
                      ),
                      show: true,
                    ),
